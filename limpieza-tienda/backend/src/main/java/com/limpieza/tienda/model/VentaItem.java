...
/**
 * Ítem de una venta de mostrador. Guarda un "snapshot" (nombre y precio al
 * momento de la venta) para que el historial no cambie si luego se modifica
 * el catálogo.
 */
@Entity
...
public class VentaItem {
    ...
    @Column(name = "producto_nombre", nullable = false, length = 160)
    private String productoNombre;

    @Column(name = "variante_nombre", length = 160)
