...
import com.limpieza.tienda.dto.AiAskRequest;
...
import com.limpieza.tienda.service.AiInventoryService;
...
public class AdminController {
    ...
    @PostMapping("/ai/ask")
    public AiAskResponse preguntarIa(@Valid @RequestBody AiAskRequest request) {
        return aiInventoryService.responder(request.pregunta().trim());
    }
